...
import hb.web.internal.rest.common : RestInterface, Route, SubInterfaceType;
...
URLRouter registerRestInterface(TImpl)(URLRouter router, TImpl instance, RestInterfaceSettings settings = null)
{
	...
	import hb.web.internal.rest.common : ParameterKind;
...
{
	import hb.web.internal.rest.jsclient : generateInterface, JSRestClientSettings;
...
private {
	...
	T fromRestString(T)(string value)
	{
		...
		import hb.web.common : HTTPStatusException, HTTPStatus;
		try {
...
unittest
{
	...
	static assert (imports == "static import hb.web.rest;");
}
